                            ...
                            <div class="col-12 grid-margin stretch-card">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form action="<?php echo site_url('dosen_controller/save'); ?>" method="post" class="forms-sample">
                                            <div class="form-group">
                                                <label for="nama_dosen">Nama</label>
                                                <input type="text" class="form-control" id="nama_dosen" name="nama_dosen" placeholder="Nama" required/>
                                            </div>
                                            <div class="form-group">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered">
                                                ...
                                                <tbody>
                                                    ...
                                                    $no = 1;
                                                    foreach ($tb_dosen as $br) {
                                                    ?>
                                                        <tr>
                                                            <td><?php echo $no++ ?></td>
                                                            <td><?php echo $br->nama_dosen ?></td>


                                                            <td><?php echo $br->nidn ?></td>

                                                            <td>
                                                                <a class="btn btn-warning btn-sm" href="<?php echo site_url('dosen_Controller/edit/' . $br->id); ?>" class="btn btn-small"><i class="fa fa-edit"></i>Edit</a>
                                                                <a class="btn btn-danger btn-sm" data-toggle="modal" data-target="#staticModal<?php echo $br->id; ?>" onclick="confirm_modal('<?php echo site_url('dosen_controller/hapus/' . $br->id); ?>','Title');" class="btn btn-small"><i class="fa fa-trash-o"></i>Hapus</a>
                                                            </td>
                                                        </tr>
